...
namespace TODOit.Resources
{
    ...
    public partial class MainWindowTemplate
    {
        ...
        void CloseBtnClick(object sender, RoutedEventArgs e)
        {
            sender.ForWindowFromTemplate(w => SystemCommands.CloseWindow(w));
        }

        void MinBtnClick(object sender, RoutedEventArgs e)
        {
            sender.ForWindowFromTemplate(w => SystemCommands.MinimizeWindow(w));
        }

        void MaxBtnClick(object sender, RoutedEventArgs e)
        {
